"""Native cognis-connect emit for openazure — forward findings to any platform.

Maps openazure's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    openazure ... --format json | openazure-emit --to stix
    openazure-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
